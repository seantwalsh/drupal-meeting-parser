let scraper = {
  ...
  endThread: function() {
    if (this.isParsing()) {
      ...
      if (this.threadCredits === true) {
        ...
        button.style.backgroundColor = '#003cc5';
  ...
  addThread: function () {
    ...
    if (this.threadCredits === null) {
      ...
      let button = document.querySelector('#drupal-meeting-parser-add-with-credit-button');
      button.style.backgroundColor = '#d3d4d9';
      button.style.color = '#232429';
...
setTimeout(function() {
  ...
  let style="width:180px;height:30px;margin-left:5px;margin-right:5px;background-color:#003cc5;color:#ffffff;cursor:pointer;display:inline-block;border-radius:4px;border: 1px solid black;box-shadow: 1px 1px #ddd;";
  ...
  displayThread.setAttribute('style', style + 'background-color:#d3d4d9;color:#232429;');
